...
SolidTexture::SolidTexture(float r, float g, float b, float a) : SolidTexture(GL_UNSIGNED_BYTE, r, g, b, a) { }

SolidTexture::SolidTexture(int fmt, float r, float g, float b, float a)
{
	this->fmt = fmt;
